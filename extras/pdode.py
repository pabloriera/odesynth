...
class generate(pyext._class):
    ...
    def build_1(self):
        ...
        print os.getcwd()
        pyode.parse(self.NAME,self.VARIABLES,self.PARAMETROS,self.FORMULA,self.INPUTS)
        pyode.build(self.NAME)
        pyode.patch(self.NAME,self.PARAMETROS,self.INPUTS,self.VARIABLES)
